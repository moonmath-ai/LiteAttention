...
cutlass_path = os.environ.get("CUTLASS_PATH", os.path.expanduser("~/libs/cutlass"))
...
if os.path.isdir(tools_util_include):
    ...
    tools_util_include_alt = os.path.join(
        cutlass_include_parent, "tools", "util", "include"
    )
...
quant_cu_path = os.path.join(
    os.path.dirname(__file__), "..", "hopper", "_internal", "cpp", "quant.cu"
)
