...
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    typename CollectiveMainloop::Arguments mainloop_args {
        ...
        params.window_size_left, params.window_size_right, params.attention_chunk,  // Local attention window parameters
    ...
    typename CollectiveEpilogue::Arguments epilogue_args {
        ...
        params.cu_seqlens_q, params.seqused_q  // Variable length sequence metadata
    };
