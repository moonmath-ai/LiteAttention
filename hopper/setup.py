...
if not SKIP_CUDA_BUILD:
    ...
    sources_fwd_sm80 = [f"instantiations/lite_fwd_hdim{hdim}_{dtype}{paged}{split}{softcap}_sm80.cu"
    ...
    sources_fwd_sm90 = [f"instantiations/lite_fwd_hdim{hdim}_{dtype}{paged}{split}{softcap}{packgqa}_sm90.cu"
