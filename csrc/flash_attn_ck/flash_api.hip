...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
        ...
        m.def("get_tile_size_fwd_sm90", [](int head_dim, int head_dim_v, bool is_causal, bool is_local, int element_size,
            ...
            // Return tile sizes for AMD/CK QR_LITE kernels.
            // kBlockM is always 128; kBlockN varies by head_dim:
            //   head_dim <= 64  -> kBlockN=64  (d32, d64 use fmha_fwd_traits_<64, ..., 128, 64, ...>)
            //   head_dim <= 128 -> kBlockN=64  if head_dim==128, else 128 for d96
            //   head_dim > 128  -> kBlockN=128 (d192, d256)
            ...
            return std::vector<int>{128, kBlockN, 0, 0};
